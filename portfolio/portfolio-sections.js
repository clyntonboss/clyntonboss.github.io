  ...
  impactosResultados: {
    ...
    content: `
      ...
      <div class="project-section">
          <button class="project-summary" aria-expanded="false">
          ...
          <div class="disclosure-content">
              <div class="tech-subtitle">
                  Estruturação, padronização e melhoria contínua de fluxos operacionais e administrativos.
              </div>
              ...
              <div class="tech-desc">
                  Mapeamento de rotinas, reorganização de fluxos operacionais e aplicação de soluções tecnológicas adequadas à realidade de cada contexto.
              </div>
      
              <div class="tech-title">Resultado Alcançado:</div>
              <div class="tech-desc">
                  Redução de retrabalho, maior previsibilidade operacional e padronização de procedimentos.
              </div>
          </div>
      </div>
      ...
      <div class="project-section">
          ...
          <div class="disclosure-content">
              <div class="tech-subtitle">
                  Transformação de dados em informação clara e acionável.
              </div>
      
              <div class="tech-title">Situação Inicial:</div>
              <div class="tech-desc">
                  Dados dispersos e ausência de indicadores claros.
              </div>
      
              <div class="tech-title">Abordagem Adotada:</div>
              <div class="tech-desc">
                  Consolidação de fontes e desenvolvimento de soluções analíticas.
              </div>
      
              <div class="tech-title">Resultado Alcançado:</div>
              <div class="tech-desc">
                  Maior clareza informacional e apoio efetivo à decisão.
              </div>
          </div>
      </div>
      ...
      <div class="project-section">
          ...
          <div class="disclosure-content">
              <div class="tech-subtitle">
                  Aplicação de soluções tecnológicas alinhadas ao contexto.
              </div>
      
              <div class="tech-title">Situação Inicial:</div>
              <div class="tech-desc">
                  Desafios na gestão da informação e suporte reativo.
              </div>
      
              <div class="tech-title">Abordagem Adotada:</div>
              <div class="tech-desc">
                  Atuação próxima às equipes com foco em organização e cultura orientada a dados.
              </div>
      
              <div class="tech-title">Resultado Alcançado:</div>
              <div class="tech-desc">
                  Melhor aproveitamento dos recursos e maior autonomia dos usuários.
              </div>
          </div>
      </div>
