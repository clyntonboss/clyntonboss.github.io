...
// 🔹 ================================================== Home ================================================ 🔹
  ...
  home: {
    ...
    content: `
      ...
      <p>
          Minha abordagem integra <strong>processos de ETL, modelagem estruturada, visualização interativa e análises: descritiva, diagnóstica, preditiva, prescritiva, exploratória e
          qualitativa</strong>, garantindo que cada insight seja não apenas preciso, mas aplicável e relevante para o contexto da organização. Acredito que todo conjunto de dados carrega
          uma narrativa valiosa — e meu papel é revelá-la com rigor analítico e comunicação clara, traduzindo complexidade em entendimento estratégico.
      </p>
