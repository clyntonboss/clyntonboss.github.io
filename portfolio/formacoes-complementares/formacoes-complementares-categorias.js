const categoriasFormacoesComplementares = {
  analiseDados: {
    ...
    showViewModes: true,
    content: `
      <div class="tech-subtitle">Esta seção reúne formações complementares na área de Análise de Dados, organizadas por conclusão cronológica.<br>
                                 Os cursos apresentados abrangem fundamentos analíticos, estatística, visualização de dados, ferramentas de BI e práticas aplicadas à tomada de decisão orientada por dados.</div>
  ...
  dataStorytelling: {
    ...
    content: `
      ...
      <div class="tech-subtitle">As formações em Data Storytelling fortaleceram a capacidade de transformar análises e indicadores em narrativas compreensíveis e relevantes para diferentes públicos.<br>
  ...
  cloud: {
    ...
    content: `
      ...
      <div class="tech-subtitle">As formações em Cloud contribuíram para a compreensão de arquiteturas, serviços e modelos de uso em ambientes de computação em nuvem, com foco em escalabilidade, disponibilidade e eficiência.<br>
                                 Esses conhecimentos apoiam a implementação e o suporte a soluções analíticas, sistemas e serviços de dados, integrando infraestrutura e aplicações de forma segura e orientada às necessidades do negócio.</div>
    `
  },
  ...
  gestaoFinanceira: {
    ...
    content: `
      ...
      <div class="tech-subtitle">As formações em Gestão Financeira contribuíram para o desenvolvimento de uma visão analítica sobre custos, receitas e indicadores econômicos.<br>
  ...
  autoconhecimento: {
    ...
    content: `
      ...
      <div class="tech-subtitle">As formações em Autoconhecimento contribuíram para o desenvolvimento de habilidades relacionadas à autoconsciência, equilíbrio emocional e melhoria da comunicação.<br>
...
idiomas: {
    ...
    content: `
      ...
      <div class="tech-subtitle">As formações em Idiomas contribuíram para o aprimoramento da comunicação em contextos profissionais e técnicos.<br>
